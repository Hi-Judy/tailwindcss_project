...
<div class="max-w-7xl mx-auto h-screen" >
    ...
    <div class="flex flex-row mt-5 h-2/6">
        <!-- 구역 1 시작 -->
        <div class="basis-2/3 w-80 p-8 ml-3 mb-3 ">
            <!-- 이미지 슬라이드 시작 -->
            <div class="relative">
            ...
            <div class="overflow-hidden relative h-56 rounded-lg sm:h-64 xl:h-80 2xl:h-96">
                ...
                <div id="carousel-item-1" class=" duration-700 ease-in-out">
                    ...
                    <img src=".././twc_img/lg_g14961300222974_08.연미색.jpg" class="block absolute top-1/2 left-1/2 w-full -translate-x-1/2 -translate-y-1/2" alt="...">
                ...
                <div id="carousel-item-2" class="hidden duration-700 ease-in-out">
                    <img src=".././twc_img/lg_g14961300199633_011.연회색.jpg" class="block absolute top-1/2 left-1/2 w-full -translate-x-1/2 -translate-y-1/2" alt="...">
                ...
                <div id="carousel-item-3" class="hidden duration-700 ease-in-out">
                    <img src=".././twc_img/lg_f14961300242496_02.물색.jpg" class="block absolute top-1/2 left-1/2 w-full -translate-x-1/2 -translate-y-1/2" alt="...">
                    <!-- <div class="carousel-caption hidden md:block absolute text-center">
        ...
        <!-- 구역 2 시작 -->
        <div class="basis-1/3 w-80 p-8 ml-3 mb-3 ">
            <div>
                <!-- item 1-->
                <div class="mt-3 mb-3">
                    <div>
